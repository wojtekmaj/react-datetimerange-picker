...
export type DateTimeRangePickerProps = {
  ...
  /**
   * Whether the date time range picker should be disabled.
   *
   * @default false
   * @example true
   */
  ...
  /**
   * `id` attribute for the main React-DateTimeRange-Picker `<div>` element.
   *
   * @example 'datetimerange-picker'
   */
  id?: string;
   ...
   *
   * Don't need hour picking? Try [React-DateRange-Picker](https://github.com/wojtekmaj/react-daterange-picker)!
   *
   * @default 'minute'
   * @example 'second'
   */
  ...
  /**
   * Divider between datetime inputs.
   *
   * @default '–'
   * @example ' to '
   */
...
export default function DateTimeRangePicker(props: DateTimeRangePickerProps): React.ReactElement {
  const {
    amPmAriaLabel,
    autoFocus,
    calendarAriaLabel,
  ...
  function onChange(value: Value, shouldCloseWidgets = shouldCloseWidgetsOnSelect) {
    if (shouldCloseWidgets) {
